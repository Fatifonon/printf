#include "main.h"
/**
 * handle_write_char - function prints an string
 * @c: char types
 ...
 * @ind: index at which num starts on the buffer
 * @buffer: buffer
 * @flags: flags
 * @width: width
 * @prec: precisioin specifier
 * @length: length
 * @padd: padding char
 * @extra_c: extra char
...
* @ind: index were num starts in buffer
